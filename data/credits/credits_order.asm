...
; commands that are used to go to the next set of credits texts.
	...
	db CRED_PROGRAMMERS, CRED_TA_OOTA, CRED_MORIMOTO, CRED_OLDHARMONY, CRED_TEXT_FADE
	...
	db CRED_TRANS, CRED_FABRI, CRED_OLDHARMONY, CRED_WRUTSCHGELUCK, CRED_TEXT_FADE
