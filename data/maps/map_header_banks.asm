...
MapHeaderBanks::
	...
	db BANK(Route20Gate_h)
	db $1D ; UNUSED_MAP_6A
	db $1D ; UNUSED_MAP_6B
	db BANK(VictoryRoad1F_h)
	db BANK(UndergroundPathPalletTown_h) ; UNUSED_MAP_6D
	db BANK(UndergroundPathPalletViridian_h) ; UNUSED_MAP_6E
	db $1D ; UNUSED_MAP_6F
	db BANK(UndergroundPathViridianCity_h) ; UNUSED_MAP_70
