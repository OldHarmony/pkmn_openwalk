...
PalletTown_Object:
	...
	warp_event 15,  7, BLUES_HOUSE, 1
	warp_event 12, 13, OAKS_LAB, 2
	warp_event  9,  3, UNDERGROUND_PATH_PALLETTOWN, 2

	def_bg_events
	bg_event 13, 15, TEXT_PALLETTOWN_OAKSLAB_SIGN
	bg_event  7,  9, TEXT_PALLETTOWN_SIGN
	bg_event  3,  7, TEXT_PALLETTOWN_PLAYERSHOUSE_SIGN
	bg_event 13,  7, TEXT_PALLETTOWN_RIVALSHOUSE_SIGN

	def_object_events
	object_event 10,  5, SPRITE_OAK, STAY, RIGHT, TEXT_PALLETTOWN_OAK
