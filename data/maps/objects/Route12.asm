Route12_Object:
	...
	bg_event 11, 67, 12 ; Route12Text12

	def_object_events
	object_event 10, 66, SPRITE_SNORLAX, STAY, DOWN, 1 ; person
	object_event 14, 31, SPRITE_FISHER, STAY, LEFT, 2, OPP_FISHER, 3
	object_event  8, 40, SPRITE_FISHER, STAY, UP, 3, OPP_FISHER, 4
	...
	object_event 10, 56, SPRITE_FISHER, STAY, RIGHT, 7, OPP_FISHER, 6
	object_event  6, 87, SPRITE_FISHER, STAY, DOWN, 8, OPP_FISHER, 11
	object_event  8, 33, SPRITE_POKE_BALL, STAY, NONE, 9, TM_PAY_DAY
