...
Route12_Object:
	...
	bg_event 11, 67, TEXT_ROUTE12_SPORT_FISHING_SIGN

	def_object_events
	object_event 10, 66, SPRITE_SNORLAX, STAY, DOWN, TEXT_ROUTE12_SNORLAX
	object_event 14, 31, SPRITE_FISHER, STAY, LEFT, TEXT_ROUTE12_FISHER1, OPP_FISHER, 3
	object_event  8, 40, SPRITE_FISHER, STAY, UP, TEXT_ROUTE12_FISHER2, OPP_FISHER, 4
	...
	object_event 10, 56, SPRITE_FISHER, STAY, RIGHT, TEXT_ROUTE12_FISHER4, OPP_FISHER, 6
	object_event  6, 87, SPRITE_FISHER, STAY, DOWN, TEXT_ROUTE12_FISHER5, OPP_FISHER, 11
	object_event  8, 33, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE12_TM_PAY_DAY, TM_PAY_DAY
