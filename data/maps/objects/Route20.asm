Route20_Object:
	...
	object_event 25,  9, SPRITE_SWIMMER, STAY, UP, 8, OPP_BEAUTY, 7
	object_event 19, 12, SPRITE_SWIMMER, STAY, DOWN, 9, OPP_JR_TRAINER_F, 16
	object_event 10, 11, SPRITE_SWIMMER, STAY, UP, 10, OPP_BEAUTY, 8
