MapSongBanks::
	...
	db MUSIC_ROUTES1, BANK(Music_Routes1) ; UNDERGROUND_PATH_PALLETTOWN
	db MUSIC_ROUTES1, BANK(Music_Routes1) ; UNDERGROUND_PATH_PALLETTOWN_VIRIDIANCITY
	db MUSIC_SILPH_CO, BANK(Music_SilphCo) ; UNUSED_MAP_6F
	db MUSIC_ROUTES1, BANK(Music_Routes1) ; UNDERGROUND_PATH_VIRIDIANCITY
